...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
                ...
                <div class="flex flex-col breaks-words bg-white border border-2 shadow-md mt-20">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            @error('name')
                                <span class="bg-red-100 text-red-700 p-4 w-full mt-5 border-l-4 border-red-500" role="alert">
        ...
        <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
            <h1 class="text-gray-600 text-3xl">¿ Eres reclutador ? </h1>
            <p class="text-xl mt-5 leading-7">Crea una cuenta totalmente gratís y empeza a publicar hasta 10 vacantes</p>
        </div>
    </div>
</div>
@endsection
