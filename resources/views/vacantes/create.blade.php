...
@section('content')
    <h1 class="text-center text-2xl mt-10">Nueva vacante</h1>

    <form class="max-w-lg mx-auto my-10" action="{{route('vacantes.store')}}" method="post" >
        @csrf
        <div class="mb-5">
            <label class="block text-gray-700 text mb-2">Titulo vacante:</label>
        ...
        <button
            ...
            p-3 focus:outline-none focus:shadow-outline uppercase">Agregar Vacante
        </button>
    </form>
